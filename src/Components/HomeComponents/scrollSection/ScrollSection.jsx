...
const ScrollSection = () => {
  ...
  return (
    <section className="scroll__section">
      ...
      >
        <img src={scrollImage1} className="scroll__img" alt="scroll1" />
        <img src={scrollImage2} className="scroll__img" alt="scroll2" />
        <img src={scrollImage3} className="scroll__img" alt="scroll3" />
      </div>
      <div className="slogan__div">
        <h2 className="slogan merriweather">
          The <span className="scroll__span">Smart</span> choise
        </h2>
        <h3 className="slogan merriweather">
          For
